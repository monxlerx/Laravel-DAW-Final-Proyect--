@extends ('dashboards.teacher-dashboard')
                    ...
                    <div class="col-12 d-inline-flex row d-flex justify-content-center">
                        <div class="col-md-3 col-sm-6 col-12 display-inline">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Courses purchase</span>
                                    <span class="info-box-number">{{count($soldCourses)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-12 d-flex-inline">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Courses available</span>
                                    <span class="info-box-number">{{count($availableCourses)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-12 display-inline">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">{{count($soldExams)}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 col-12 display-inline">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Exams available</span>
                                    <span class="info-box-number">{{count($typeExams)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-6 d-inline-flex row d-flex justify-content-between">
                ...
                <div class="card card-primary d-flex-inline">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <strong><i class="fas fa-user-graduate"></i></i> Working at Holyrood English since</strong>
                        <p class="text-muted">{{auth()->user()->created_at->diffForHumans()}}</p>
                        <hr>
                        <strong><i class="fas fa-door-open"></i>Contact us</strong>
                        <p class="text-muted">
                            If you have any problem you can talk directly with the administrator or write through the
                        ...
                        <div class="active tab-pane" id="activity">
                            ...
                            <div class="post">
                                ...
                                <div class="text-center mb-3">
                                    <span>
                                        <img src="{{asset('images/abstract_image_post.jpg')}}" alt="image_post"
                                            height="250">
                                    </span>
                                </div>
                                <p>
